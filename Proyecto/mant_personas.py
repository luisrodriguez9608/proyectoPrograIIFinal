...
class Aplicacion:
    ...
    def __init__(self):
        ...
        self.lb_apellido = Label(self.raiz, text = "Apellido:")
        self.lb_apellido.place(x = 240, y = 120)
        self.txt_apellido = Entry(self.raiz, textvariable=self.persona.apellido, justify="right", width=30)
        self.txt_apellido.place(x = 370, y = 120)
 ...
 #coloca en el formulario el campo y el label de observaciones
        ...
        self.txt_estado.place(x = 370, y = 280)
        ...
        self.sheet = Sheet(self.raiz,
                           ...
                           #header_align = "w",
                            ...
                            headers = ['Cédula', 'Nombre', 'Apellido.', 'Fec. Nacimiento', 'Estado'],
